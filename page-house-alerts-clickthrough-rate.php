        ...
        <div class="box blue-bg no-bottom">
            <div class="row text-center">
                <div class="col-lg-8 col-12">
                    <h2 class="text-left">
                        <span>How House Alerts Help To Obtain Higher Click-Through Rates</span>
                    </h2>
                    <p>         
                    ...
                    <h3 class="text-left mt-2">
                        <span>Step one: collect their preferences</span>
                    </h3>
                    ...
                    <h3 class="text-left mt-2">
                        <span>Step two: collect email addresses</span>
                    </h3>
                    <p>
                    ...
                    <h3 class="text-left mt-2">
                        <span>Step three: provide house alerts</span>
                    </h3>
                    <p>
