    ...
    <div class="container">
        <div class="privacy-title-content">
            <h1 class="text-center">
                <span>Privacy</span>
                <span class="blue-text">policy</span>
...
<section class="mt-5">
    <div class="container">
        ...
        <h2 class="wp-block-heading mt-5">Introduction</h2>
        <p>Guide2Property NV (“we” or “us” or “our”) respects the privacy of our users (“user” or “you”). This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website https://colibry.ai, including any other media form, media channel, mobile website, or mobile application related or connected thereto (collectively, the “Site”). Please read this privacy policy carefully.  If you do not agree with the terms of this privacy policy, please do not access the site.</p>
        ...
        <h2 class="wp-block-heading mt-5">Who we are</h2>
        <p>Our website address is: http://www.colibry.ai.</p>

        <h2 class="wp-block-heading mt-5">Collection of your information</h2>
        <p>We may collect information about you in a variety of ways. The information we may collect on the Site includes:</p>

        <h3 class="wp-block-heading mt-3">Personal data</h3>
        <p>Personally identifiable information, such as your name, shipping address, email address, and telephone number, and demographic information, such as your age, gender, hometown, and interests.You are under no obligation to provide us with personal information of any kind, however your refusal to do so may prevent you from using certain features of the Site.</p>

        <h3 class="wp-block-heading mt-3">Derivative data</h3>
        ...
        <h3 class="wp-block-heading mt-3">Facebook permissions</h3>
        ...
        <h3 class="wp-block-heading mt-3">Data from social networks</h3>
        <p>User information from social networking sites, such as Facebook or LinkedIn, including your name, your social network username, location, gender, birth date, email address, profile picture, and public data for contacts, if you connect your account to such social networks.</p>

        <h3 class="wp-block-heading mt-3">Mobile device data</h3>
        ...
        <h3 class="wp-block-heading mt-3">Third-party data</h3>
        ...
        <h3 class="wp-block-heading mt-3">Data from contests, giveaways and surveys</h3>
        <p>Personal and other information you may provide when entering contests or giveaways and/or responding to surveys.</p>



        <h2 class="wp-block-heading mt-5">Use of your information</h2>
        ...
        <h2 class="wp-block-heading mt-5">Disclosure of your information</h2>
        <p>We may share information we have collected about you in certain situations. Your information may be disclosed as follows:</p>
        <h3 class="wp-block-heading mt-3">By law or to protect rights</h3>
        ...
        <h3 class="wp-block-heading mt-3">Third-party service providers</h3>
        <p>We may share your information with third parties that perform services for us or on our behalf, including payment processing, data analysis, email delivery, hosting services, customer service, and marketing assistance.</p>
        <h3 class="wp-block-heading mt-3">Marketing communications</h3>
        ...
        <h3 class="wp-block-heading mt-3">Interactions with other users</h3>
        ...
        <h3 class="wp-block-heading mt-3">Third-party advertisers</h3>
        <p>We may use third-party advertising companies to serve ads when you visit the. These companies may use information about your visits to the Site and other websites that are contained in web cookies in order to provide advertisements about goods and services of interest to you.</p>
        <h3 class="wp-block-heading mt-3">Business partners</h3>
        <p>We may share your information with our business partners to offer you certain products, services or promotions.</p>
        <h3 class="wp-block-heading mt-3">Other third parties</h3>
        ...
        <h2 class="wp-block-heading mt-5">Tracking technologies</h2>
        <h3 class="wp-block-heading mt-3">Cookies and web beacons</h3>
        ...
        <h3 class="wp-block-heading mt-3">Internet-based advertising</h3>
        <p>Additionally, we may use third-party software to serve ads on the Site implement email marketing campaigns, and manage other interactive marketing initiatives.  
            ...
            For more information about opting-out of interest-based ads, visit the <a href="https://optout.networkadvertising.org/?c=1" target="_blank" rel="noopener noreferrer"> Network Advertising Initiative Opt-Out Tool or <a href="https://optout.aboutads.info/?c=2&lang=EN" target="_blank" rel="noopener noreferrer"> Digital Advertising Alliance Opt-Out Tool.</p>
        
        <h3 class="wp-block-heading mt-3">Website analytics</h3>
        <p>We may also partner with selected third-party vendors, such Google Analytics, Hotjar, Mailerlite, Google Tag Manager, Facebook Pixel, LinkedIn Tracking to allow tracking technologies and remarketing services on the Site through the use of first party cookies and third-party cookies, to, among other things, analyze and track users’ use of the Site, determine the popularity of certain content and better understand online activity. By accessing the Site, you consent to the collection and use of your information by these third-party vendors. You are encouraged to review their privacy policy and contact them directly for responses to your questions. We do not transfer personal information to these third-party vendors. However, if you do not want any information to be collected and used by tracking technologies, you can visit the third-party vendor or the <a href="https://optout.networkadvertising.org/?c=1" target="_blank" rel="noopener noreferrer">Network Advertising Initiative Opt-Out Tool or <a href="https://optout.aboutads.info/?c=2&lang=EN" target="_blank" rel="noopener noreferrer"> Digital Advertising Alliance Opt-Out Tool.</p>
        ...
        <h2 class="wp-block-heading mt-5">Security of your information</h2>
        ...
        <h2 class="wp-block-heading mt-5">Options regarding your information</h2>
        <h3 class="wp-block-heading mt-3">Emails and communications</h3>
        ...
        <h2 class="wp-block-heading mt-5">Contact us</h2>
