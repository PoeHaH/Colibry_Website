...
<section class="mt-5">
    <div class="container">
        ...
        <h3 class="wp-block-heading">Derivative data</h3>
        ...
        <h3 class="wp-block-heading">Facebook permissions</h3>
        ...
        <h3 class="wp-block-heading">Data from social networks</h3>
        ...
        <h3 class="wp-block-heading">Mobile device data</h3>
        ...
        <h3 class="wp-block-heading">Data from contests, giveaways and surveys</h3>
        ...
        <h3 class="wp-block-heading">Emails and communications</h3>
        ...
        <p>Antoinette-Vandeputtepad 25 bus 102</p>
        <p>9000 Gent</p>
